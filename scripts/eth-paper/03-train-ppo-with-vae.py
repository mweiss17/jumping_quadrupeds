...
from jumping_quadrupeds.models.model import MLP
from jumping_quadrupeds.utils import get_args
...
def train(env, hyperparameters, actor_model, critic_model):
    ...
    model = PPO(policy_class=MLP, vae_class=vae_class, lstm_class=torch.nn.LSTM, env=env, **hyperparameters)
...
def test(env, actor_model):
    ...
    eval_policy(policy=policy, env=env, render=True)  # TODO
